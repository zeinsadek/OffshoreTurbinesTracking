...
videoSaveName = sprintf('OffshoreMotion_RealSignal_%s_%s_%s_Turbine_%s_FadingGrowingTest.mp4', farm_arrangement, farm_spacing, wave, num2str(turbine));
